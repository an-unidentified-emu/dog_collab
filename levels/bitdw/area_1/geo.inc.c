...
const GeoLayout bitdw_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 11460, -5893, 11435, bitdw_dl_Cylinder_mesh_layer_5),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 9495, -1652, 7909),
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 12900, -3139, 7299),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(-4096, 10000),
			GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -1949, -1287, -994, 0, -172, 0),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 655, -1139, -1299, -2, -180, -2),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 897, -997, -362, 0, 135, 0),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -246, -892, -1619, 0, 135, 0),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 548, -838, 580, 0, 135, 0),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 11460, -3829, 6276, 0, 0, 43, bitdw_dl_slidey_stuff_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bitdw_dl_slidey_stuff_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 9558, -8525, 8620, bitdw_dl_start_platform_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bitdw_dl_start_platform_mesh_layer_5),
		GEO_CLOSE_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 3968, 243, 6095, 0, 59, 0),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(-4096, 10000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, bitdw_dl_steppingstones_001_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 7280, 1792, -5866, 0, 59, 0),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(-4096, 10000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, bitdw_dl_steppingstones_002_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 1862, 2103, -1650, 0, 59, 0),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(-4096, 10000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, bitdw_dl_steppingstones_003_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5658, -122, 6401, -90, 0, 0, bitdw_dl_Torus_001_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5598, -143, 5674, 90, 0, 0, bitdw_dl_Torus_002_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 2903, 1950, -2341, 0, 0, 90, bitdw_dl_Torus_003_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bitdw_dl_Torus_003_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 2903, 1950, -2341, 0, 0, 90, bitdw_dl_Torus_004_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 5346, 2392, -3867, -90, 0, 0, bitdw_dl_Torus_005_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 2903, 1950, -2341, 0, 0, 90, bitdw_dl_Torus_006_mesh_layer_1),
		...
		GEO_OPEN_NODE(),
			GEO_ROTATION_NODE(LAYER_OPAQUE, 7, 8, -39),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(-4096, 10000),
				GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, -491, -274, -1907, 0, 0, 18, bitdw_dl_TOWER_003_mesh_layer_5),
			GEO_RENDER_RANGE(10000, 30000),
			GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -4981, 4223, -2457, 3, 5, -35),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
