...
const LevelScript level_bitdw_entry[] = {
	...
	AREA(1, bitdw_area_1),
		...
		OBJECT(0x1AA, 3391, 1864, -10724, 0, 0, 0, 0x00000000, bhvRotatingTorus),
		OBJECT(0x1AA, -56, 1864, -10724, -90, 0, 180, 0x00000000, bhvRotatingTorus),
		OBJECT(0x1AA, -3512, 1864, -10724, 0, 0, 0, 0x00000000, bhvRotatingTorus),
		OBJECT(MODEL_NONE, 12066, -3634, 9035, 0, -177, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 12883, -2750, 7083, 0, 1, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_HEART, 10450, -6637, 11899, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		OBJECT(MODEL_HEART, 11787, -4451, 10242, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		...
		OBJECT(MODEL_RED_COIN, 10269, -7310, 7673, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 2002, -5151, 7479, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 5968, -4101, 6585, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 10131, -4684, 6152, 0, 0, 0, 0x00000000, bhvRedCoin),
