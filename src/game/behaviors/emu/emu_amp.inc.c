...
void bhv_attackable_amp_init(void) {
    ...
    o->childObj = doggoObj;
    if (o->parentObj->oHealth == 3) o->oPiranhaPlantScale = 25.0f;
    else if (o->parentObj->oHealth == 2) o->oPiranhaPlantScale = 30.0f;
    else if (o->parentObj->oHealth == 1) o->oPiranhaPlantScale = 40.0f;
    else {o->oPiranhaPlantScale = 50.0f;}
